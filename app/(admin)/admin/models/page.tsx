  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--foreground-muted)] mb-6">
        Каталог автомобилей, доступных в выпадающих списках бронирования и каталога запчастей. Модель = марка и название (например, Mercedes-Benz G-Class). Поколение = шасси-код и годы выпуска (например, W464, 2018–н.в.).
      </p>
