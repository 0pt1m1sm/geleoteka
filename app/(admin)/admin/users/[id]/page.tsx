      ...
      {viewerIsAdmin && !isSelf && (
        <div className="mt-6 card border-[var(--color-error)]/30">
          ...
          <p className="text-sm text-[var(--foreground-muted)] mb-3">
            Стирает персональные данные — карточку, контакты, заметки и переписку. Сделки
            и заказ-наряды по умолчанию сохраняются: это записи сервиса, нужные для бухгалтерии
            и гарантии. Удалить и их можно галочкой. Сначала выгружается копия.
          </p>
          <EraseCustomerPanel
