# Master Backlog — УСТАРЕЛ, заменён docs/ROADMAP.md

> **Не пользоваться.** Составлен 2026-05-21 и с тех пор разошёлся с действительностью:
> склад, описанный здесь как «почти не построенный», построен и работает в проде вместе с
> адресным хранением, сканером и журналом движений; CRM, почта и уведомления тоже выкачены.
>
> Действующий бэклог: **`docs/ROADMAP.md`** (собран 2026-09-01, сверен по коду и истории).
> Прежнее содержимое сохранено ниже и в истории git — оно полезно только как срез мая.
