...
const CALLSITE_INVARIANTS: ReadonlyArray<{
  ...
  {
    file: "app/(public)/parts/[slug]/page.tsx",
    must: /pickVariantHost\(/,
    why:
      "канонический адрес детали берётся у хозяина вариантов; без этого новый " +
      "товар и б/у экземпляры конкурируют за один запрос",
  },
];
