...
const ALLOWED: Readonly<Record<string, string>> = {
  // Содержимое публичного сайта Гелеотеки: 96 ключей умолчаний, из которых
  // рендерится боевой сайт. Уйдёт, когда содержимое будет перенесено в
  // редактируемые блоки (`scripts/materialize-cms-defaults.ts`), а умолчания
  // приведены к нейтральному платформенному виду.
  "lib/cms-schema.ts": "содержимое сайта первого клиента — переносится в CMSBlock",
