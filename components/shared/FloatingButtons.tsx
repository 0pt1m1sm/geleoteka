...
export function FloatingButtons() {
  return (
    <div style={{ position: "fixed", bottom: 24, right: 24, zIndex: 50, display: "flex", flexDirection: "column", gap: 12 }}>
      <a
        href="https://t.me/geleoteka"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Telegram"
        style={{
          width: 56, height: 56, borderRadius: "50%", backgroundColor: "#229ED9",
      ...
      <a
        ...
        aria-label="WhatsApp"
        style={{
          width: 56, height: 56, borderRadius: "50%", backgroundColor: "#25D366",
          color: "white", display: "flex", alignItems: "center", justifyContent: "center",
          boxShadow: "0 4px 12px rgba(0,0,0,0.3)", transition: "transform 0.2s",
        }}
        onMouseEnter={(e) => (e.currentTarget.style.transform = "scale(1.1)")}
