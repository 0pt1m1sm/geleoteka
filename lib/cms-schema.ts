...
export const CMS_SCHEMA = {
  ...
  "rentals.title": {
    ...
    defaultValue: "Аренда Гелендвагена в Москве",
  },
  "rentals.description": {
    type: "text",
    group: "rentals",
    ...
    defaultValue:
      "Mercedes-Benz G-Class на сутки и на любой срок — без водителя и с водителем",
  },
  "rentals.seo.text": {
    type: "richtext",
    group: "rentals",
    ...
    defaultValue:
      "Арендовать Гелендваген в Москве можно на сутки, на выходные или на длительный срок — как с водителем, так и без водителя. В парке — Mercedes-Benz G-Class в идеальном техническом состоянии: каждый автомобиль обслуживается в нашем собственном сервисе, а не «где придётся».\n\nГелик остаётся самым узнаваемым автомобилем для важных событий: аренда на свадьбу, встречу из роддома, съёмки или деловую поездку. Подача по Москве и области, полная страховка КАСКО, поддержка на связи круглосуточно.\n\nЦена аренды зависит от модели и срока: чем дольше срок, тем ниже стоимость суток. Точную стоимость на ваши даты видно в карточке автомобиля — бронирование онлайн за пару минут.",
  },
  "rentals.faq.items": {
    type: "list",
    group: "rentals",
    ...
    defaultValue: [
      {
        question: "Сколько стоит аренда Гелендвагена в Москве?",
        answer:
      ...
      {
        question: "Можно ли арендовать Гелик без водителя?",
        answer:
          "Да, при соответствии требованиям: возраст от 25 лет, стаж от 3 лет, паспорт РФ и действующие права категории B. Вариант с водителем тоже доступен.",
      },
      {
      ...
      },
      {
        ...
        answer: "Да, все автомобили застрахованы по КАСКО на весь срок аренды.",
      },
      {
        question: "Арендуете на свадьбу или съёмки?",
        answer:
  ...
  "rentals.terms.items": {
    ...
    defaultValue: [
      {
        title: "Страховка КАСКО включена",
        subtitle: "Полная страховая защита на весь срок аренды",
      },
      { title: "Поддержка 24/7", subtitle: "Техническая поддержка в любое время" },
      {
        title: "Доставка автомобиля",
        subtitle: "По Москве и области — за дополнительную плату",
      },
      {
        title: "Залог 50 000 ₽",
  ...
  "rentals.requirements.items": {
    ...
    defaultValue: [
      ...
      { text: "Паспорт РФ и действующее в/у категории B" },
      { text: "Залог 50 000 ₽" },
    ],
  },
  "services.cta.button": {
